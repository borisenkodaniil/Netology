...
**Ответ:** Допустим у меня 2 пользователя daniil и test. Тогда размеры файлов будут разными в зависимости от количество запускаемых процессоров определенными пользователями. Если пользователя tester - нет, то файл будет еще меньше, т.к. нет пользователя - нет процессов.
